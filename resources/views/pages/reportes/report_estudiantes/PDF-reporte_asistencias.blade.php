    ...
    <body>
        ...
        <main>           
            <div class="cuerpo-oficio mt-4">
                ...
                <div class="mt-2 text-center f15"><span class="text-gros">ESTUDIANTE:</span> {{mb_strtoupper($estudiante)}}  </div>
                ...
                <div class="mb-1">
                    <table class="table table-bordered">
                        <thead class="thead-dark-1">
                            <tr>                            
                                <th class="text-center" rowspan="2" width="50%">Asignatura</th>
                        ...
                        <tbody>
                            <tr>
                                <td class="text-left">
                                    {{mb_strtoupper($asignatura->nombre)}}
                                </td>
                                <td class="text-center">{{ $asignatura->q1_faltas - $asignatura->q1_faltas_just }}</td>
                                <td class="text-center">{{ $asignatura->q1_faltas_just }}</td>
                                <td class="text-center">{{ $asignatura->q2_faltas }}</td>
                                <td class="text-center">{{ $asignatura->q2_faltas_just }}</td>
                            </tr>
                        </tbody>
                    </table>
