        ...
        <main>           
            <div class="cuerpo-oficio mt-4">
                ...
                <div class="mt-2 f14" style="height: 70px;">
                    <div class="d-flex">
                        <div class="text-center" style="width:32%;"><span class="text-gros">GRADO/CURSO:</span> {{mb_strtoupper($asignaturas[0]->curso_nombre)}} {{mb_strtoupper($asignaturas[0]->curso_nivel)}}"{{mb_strtoupper($asignaturas[0]->curso_paralelo)}}"</div>
                ...
                <div class="mb-1">
                    <table class="table table-bordered">
                        <thead class="thead-dark-1">
                            <tr>                            
                                <th class="text-center" rowspan="2" width="50%">Asignaturas</th>
