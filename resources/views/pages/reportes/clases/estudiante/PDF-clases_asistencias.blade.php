            ...
            <div class="mb-1">
                <table class="table table-bordered">
                    ...
                    <tbody>
                        <tr>
                            <td class="text-left">
                                {{mb_strtoupper($estudiantes[0]->apellido_paterno)}}
                                {{mb_strtoupper($estudiantes[0]->apellido_materno)}}
                                {{mb_strtoupper($estudiantes[0]->primer_nombre)}}
                                {{mb_strtoupper($estudiantes[0]->segundo_nombre)}}
                            </td>
                            <td class="text-center">{{ $q1_faltas - $q1_faltas_just }}</td>
                            <td class="text-center">{{ $q1_faltas_just }}</td>
                            <td class="text-center">{{ $q2_faltas }}</td>
                            <td class="text-center">{{ $q2_faltas_just }}</td>
                        </tr>
                    </tbody>
                </table>
