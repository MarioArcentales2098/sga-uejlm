                ...
                <table class="table table-bordered">
                    <thead class="thead-dark-1">
                        <tr>
                            ...
                            <th class="text-center" width="50%">Asistencia</th>
                        </tr>
                    </thead>
                    
                    <tbody>
                        @if (sizeof($inasistencia) > 0)
                        @foreach ($inasistencia as $item)
                            <tr>
                                <td class="text-center">
                                    {{mb_strtoupper($item->fecha)}}
                                </td>
                                <td class="text-center">
                                    @php
                                        $texto = "check1.png";
                                        if ($item->asistencia == 1) {
                                            ...
                                            if ($item->asistencia_justificada == 1) {
                                                $texto = "check2.png";
                                            } else {
                                                $texto = "equis.png";
                                            }
                                    ...
                                    @endphp
                                    <img src="{{ public_path('recursos/'.$texto) }}" width="10px" height="10px"/>
                                </td>
                            </tr>
                        @endforeach
                        @else
