...
@section('title-herramienta', 'Estudiantes')
...
<div class="row">
    <div class="col-xl-12">
        <div class="page-title-box">
            <h4 class="page-title float-left">Estudiantes</h4>
            <div class="float-right">
                @can('viewGeneralEstudiantesCreate')
                <a href="javascript:" data-toggle="modal" data-target="#createRegister" class="btn btn-success waves-effect waves-light btn-sm"><i class="fa fa-user-plus"></i> Crear estudiante</a>
                @endcan
            </div>
    ...
    <div class="col-lg-12">
        <div class="card-box">
            ...
            <div class="mb-4 d-flex" style="justify-content:right; align-items: center; ">
                <div class="w-50">
                    <form action="{{ route('viewEstudiantes') }}" method="GET" id="formSearch"><input type="text" class="form-control" name="texto" value="{{$texto}}" placeholder="Buscador...." autocomplete="off"></form>
                </div>
                    ...
                    <tbody id="tbody_registros">
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                @can('viewGeneralEstudiantesEdit')
                                <!-- Editar -->
                                ...
                                @endcan
                                @can('viewGeneralEstudiantesDelete')
                                <!-- Eliminar -->
    ...
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            <div class="modal-header" style="background: #f1b53d; color: #fff;">
                <h5 class="modal-title text-dark" id="exampleModalLabel">Deshabilitar estudiante</h5>
    ...
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            <div class="modal-header" style="background: #eb877a; color: #fff;">
                <h5 class="modal-title text-dar" id="exampleModalLabel">Eliminar estudiante</h5>
...
@php $ran = rand(); @endphp
<script src="{{asset("herramienta/academico/estudiantes.js?v=$ran")}}"></script>
@endsection
