<html>
<head>
    <title>{{ $nombre }} - ASIGNATURAS</title>
    <style>
        @page {
            margin: 0cm 0cm;
    ...
    <main>
        <div class="cuerpo-oficio mt-4">
            <div class="text-center">
                <div class="f20 text-gros">REPORTE DE MATERIAS ASIGNADAS AL CURSO</div>
            </div>

            <div class="mt-2 text-center f15"><span class="text-gros">CURSO:</span> {{ mb_strtoupper($curso->nombre) }}  </div>
            <div class="mt-2 f14" style="height: 70px;">
                <div class="d-flex">
                    <div class="text-center" style="width:32%;"><span class="text-gros">GRADO/CURSO:</span> {{mb_strtoupper($curso->nivel)}}" {{mb_strtoupper($curso->paralelo)}}"</div>
                    <div class="text-center" style="width:32%; margin-left: 32.3%"><span class="text-gros">JORNADA:</span> MATUTINA</div>
                    <div class="text-center" style="width:32%; margin-left: 65%"><span class="text-gros">PERIODO:</span> {{$periodo_activo->nombre}}</div>
                </div>
            </div>
